...
Q_CONSTINIT static const qt_meta_stringdata_CLASSRegistENDCLASS_t qt_meta_stringdata_CLASSRegistENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 16),  // "registSuccessful"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 17),  // "on_regist_clicked"
        QT_MOC_LITERAL(43, 15)   // "on_quit_clicked"
    },
    "Regist",
    "registSuccessful",
    "",
...
void Regist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->registSuccessful(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Regist::registSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
