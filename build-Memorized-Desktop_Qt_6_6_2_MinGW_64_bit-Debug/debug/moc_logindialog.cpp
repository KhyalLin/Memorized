...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoginDialogENDCLASS_t qt_meta_stringdata_CLASSLoginDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 11),  // "loginFinish"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 22)   // "on_loginButton_clicked"
    },
    "LoginDialog",
    "loginFinish",
    "",
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginFinish((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginDialog::loginFinish; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::loginFinish(QString _t1)
{
